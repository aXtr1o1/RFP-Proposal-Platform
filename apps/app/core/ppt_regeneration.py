...
from .ppt_prompts import get_system_prompt, get_regeneration_prompt
...
async def run_regeneration(
    ...
    try:
        ...
        from .ppt_generation import _calculate_presentation_stats
        ...
        from .ppt_generation import _cleanup_temp_file
